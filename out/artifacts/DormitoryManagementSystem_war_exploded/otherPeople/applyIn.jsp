...
<script type="text/javascript">
    function checkForm(){
        ...
        if(selectBuild==null||selectBuild==""){
            document.getElementById("error").innerHTML="请选择宿舍楼！";
            return false;
        }
        return true;
    }
        ...
        <div class="data_form" >
            ...
            <table align="center">
                ...
                <tr>
                    ...
                    <td><input type="text" id="dormBuildName"  name="visit_timeNew"   value = "<%=nowDateTime%>"  readonly = "true" style="margin-top:5px;height:30px;" /></td>
                </tr>
                <tr>
                    <td>&nbsp;访问说明，原因、目的：</td>
                    <td><textarea id="dormBuildName" name="visitDestNew" rows="10"></textarea></td>
                </tr>
                <tr>
