<%@ page import="com.shungen.bean.Admin" %>
<%@ page import="com.shungen.bean.DormManager" %>
<%@ page import="com.shungen.bean.Student" %>
...
<div class="container">
      <form name="myForm" class="form-signin" action="login" method="post" onsubmit="return checkForm()">
		...
		<label class="radio inline">
		  ...
		  <label class="radio inline">
			  <!--新嫁进来的--><input id="student" type="radio" name="userType" value="repairPeople"  ${userType==4?'checked':''}/> 维修人员
		  </label>
        ...
        <button class="btn btn-large btn-primary" type="submit">登录</button>
		  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button class="btn btn-large btn-primary" type="button" >重置</button><br>
		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a  href="applyIn?action=toApplyRecord">外来访问登记</a><!--直接跳转到填写表单-->

		<p align="center" style="padding-top: 15px;">版权所有  2021  shungen  <a href="http://www.shungen.com" target="_blank">http://www.shungen.com</a></p>
      </form>
</div>
</body>
</html>