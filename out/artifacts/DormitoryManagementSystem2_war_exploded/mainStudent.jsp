		...
		<div class="row-fluid">
			<div class="span2 bs-docs-sidebar" >
				<ul class="nav nav-list bs-docs-sidenav">
					...
					<li><a href="ChangeRoomRecordServlet?action=list"><i class="icon-chevron-right"></i>换寝申请</a></li>
					<li><a href="repair?action=studentRepairList"><i class="icon-chevron-right"></i>宿舍维修</a></li>
