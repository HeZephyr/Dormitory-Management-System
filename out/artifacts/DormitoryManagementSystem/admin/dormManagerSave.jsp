			...
			<div class="data_form" >
					...
					<table align="center">
						<c:if test="${dormManager.dormmasterId==null }">
							<tr>
								<td><font color="red">*</font>宿管工号:</td>
								<td><input type="text" id="userName" name="dormmasterId" value="${dormManager.dormmasterId }"/></td>
							</tr>
						</c:if>
						<tr>
...
<%--						</tr>--%>
						...
						<tr>
							<td><font color="red">*</font>管理宿舍楼：</td>
							<td><input type="text" id="userName"  name="dorm_id" value="${dormManager.dorm_id }"  style="margin-top:5px;height:30px;" /></td>
						</tr>
						<tr>
