        ...
        <table class="table table-striped table-bordered table-hover datatable">
            ...
            <c:forEach  varStatus="i" var="record" items="${allChangeRoomRecordList }">
                <tr>
                    ...
                    <td>
                        <button class="btn btn-success" type="button" style="margin-right: 10px;" onclick="javascript:window.location='ChangeRoomRecordServlet?action=del&isAgree=1&record_id=${record.record_id}'" >同意</button>
                        <button class="btn btn-success" type="button" style="margin-right: 10px;" onclick="javascript:window.location='ChangeRoomRecordServlet?action=del&&isAgree=2&record_id=${record.record_id}'">不同意</button>
<%--                        <c:if test="${record.isAgree== 0}" ><button onclick="">同意</button></c:if>--%>
