...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
    <div region="north" style="height: 100px;background-image: url('images/bgIndex.jpg')">
        <div align="left" style="width: 80%;height:100px ;float: left;padding-top: 40px;padding-left: 30px;" >
            <span style="color: white; font-size: x-large; ">宿舍管理系统</span>
        </div>
        <div style="padding-top: 70px;padding-right: 20px;">
            当前用户：&nbsp;<span style="color: red; ">${currentUser.userName }</span>
        </div>
    </div>
</div>
    ...
    <div class="row-fluid">
        <div class="span2 bs-docs-sidebar" >
            <ul class="nav nav-list bs-docs-sidenav">
                ...
                <li><a href="repair?action=list"><i class="icon-chevron-right"></i>处理维修</a></li>
